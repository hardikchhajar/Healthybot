    ...
    <form name="form1" action="register.php" method="post">
      ...
      <div class="form-group input-group">
			<div class="input-group-prepend">
			 ...
			 <select class="form-control">
				<option selected=""> Select job field</option>
      ...
      <div class="form-group input-group">
        ...
        <div class="form-group">
            <button type="submit" class="btn btn-outline-light btn-lg download-button" onclick="validate();" name="createAccount"><a href="bot.php">Create Account</a></button>
        </div> <!-- form-group// -->
